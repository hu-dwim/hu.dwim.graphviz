...
(cffi:defcstruct agedge-t  (handle :int) (attr :pointer) (head :pointer)
...
(cffi:defcstruct agnode-t  (handle :int) (attr :pointer) (name :pointer)
...
(cffi:defcstruct agraph-t  (handle :int) (attr :pointer) (name :pointer)
